...
class Program
{
    static void Main(string[] args)
    {
        ...
        Customer customer1 = new Customer("Valeria Hernandez", address1);
        ...
        Customer customer2 = new Customer("Jacob McMillan", address2);
        ...
        Customer customer3 = new Customer("Eric Pagel", address3);
